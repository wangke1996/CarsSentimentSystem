function knowledgeGraph_subset() {
    loadJS('static/kb_json/part_of_knowledgebase.js');
    ...
    var text = svg.append("g").selectAll("text")
        ...
        .style('fill',function(node){
            if(node.type=="entity")
                ...
                return "#000000";
            else if(node.type=="entity_synonym"||node.type=="attribute_synonym")
                return "#008080"
            else
                return "#1e90ff";
        })
